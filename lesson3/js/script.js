...
for (let i = 0; i < 10; i++) {
    document.write(`<div>Game of Thrones</div>`);
}

// - За допомогою циклу for і document.write() вивести 10 блоків div c довільним текстом і індексом всередині

for (let i = 0; i < 10; i++) {
    document.write(`<div>House of the Dragon - ${i}</div>`);
}
...
let i = 0;
while (i < 20) {
    document.write(`<h1>Daenerys Targaryen</h1>`);
    i++;
}
...
let i1 = 0;
while (i1 < 20) {
    document.write(`<h1>Drogon - ${i1}</h1>`);
    i1++;
}
